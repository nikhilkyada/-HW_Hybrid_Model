...
//    By _categoryBtn = By.xpath("//ul[@class='top-menu notmobile']//a[contains(text(),'"+name+"')]");
    ...
    public void clickOnComputer(String string) {
        driverClickOnElement(By.xpath("//ul[@class='top-menu notmobile']//a[contains(text(),'"+string+"')]"));
